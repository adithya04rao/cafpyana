...
def make_gump_nuslimwgtdf(f):
    return make_mcnudf(f, include_weights=True, slim=True, genie_systematics=gump_ar23_weights)

def make_gump_nuwgtdf(f):
    return make_mcnudf(f, include_weights=True, slim=False, genie_systematics=gump_ar23_weights)
